...
- An [OpenAI API key](https://platform.openai.com/api-keys)
  ...
  conda create -n agent-chatbot python=3.11
  # Activate the virtual environment
  conda activate agent-chatbot
  ```
...
## Design Choices & Trade-offs# OpenAI Agent Chatbot
...
If streaming fails midway (network drop, LLM provider error), should a partial assistant response be persisted?I
